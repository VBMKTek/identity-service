...
/**
 * Public controller for JWT token operations
 * These endpoints are used by other services to verify and manage JWT tokens
 */
@RestController
...
public class TokenController {
    ...
    public ResponseEntity<TokenResponse> generateToken(@Valid @RequestBody GetAccessTokenRequest request) {
    ...
    @Operation(
        ...
        description = "Verify JWT token and return user information. Used by other services to validate tokens."
    )
    @PostMapping("/verify")
    public ResponseEntity<TokenValidationResponse> verifyToken(@Valid @RequestBody TokenVerificationRequest request) {
