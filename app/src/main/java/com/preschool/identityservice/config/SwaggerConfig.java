        ...
        return new OpenAPI()
                .info(
                        new Info()
                                ...
                                .description(
                                        "API documentation for the Identity Service - User, Role, Group, and Permission management")
                                .version("1.0.0")
                                .contact(
                                        new Contact()
                                                .name("VBMK-Tek Team")
                                ...
                                .license(new License().name("Private License").url("https://vbmk-tek.com/license")))
                .components(
                        new Components()
                                .addSecuritySchemes(
                                        "bearerAuth",
