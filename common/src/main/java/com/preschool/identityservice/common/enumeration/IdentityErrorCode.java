...
/**
 * Enum defining all error codes used in the identity service Provides centralized error code
 * management with HTTP status mapping
 */
@Getter
...
public enum IdentityErrorCode {
    ...
    USER_VALIDATION_FAILED(
            HttpStatus.BAD_REQUEST, "USER_VALIDATION_FAILED", "User validation failed"),
    ...
    ROLE_VALIDATION_FAILED(
            HttpStatus.BAD_REQUEST, "ROLE_VALIDATION_FAILED", "Role validation failed"),
    ...
    PERMISSION_ALREADY_EXISTS(
            HttpStatus.CONFLICT, "PERMISSION_ALREADY_EXISTS", "Permission already exists"),
    PERMISSION_VALIDATION_FAILED(
            HttpStatus.BAD_REQUEST, "PERMISSION_VALIDATION_FAILED", "Permission validation failed"),
    PERMISSION_IN_USE(
            HttpStatus.CONFLICT,
            "PERMISSION_IN_USE",
    ...
    GROUP_VALIDATION_FAILED(
            HttpStatus.BAD_REQUEST, "GROUP_VALIDATION_FAILED", "Group validation failed"),
    GROUP_HAS_USERS(
            HttpStatus.CONFLICT, "GROUP_HAS_USERS", "Group contains users and cannot be deleted"),
    ...
    KEYCLOAK_SERVICE_ERROR(
            HttpStatus.INTERNAL_SERVER_ERROR, "KEYCLOAK_SERVICE_ERROR", "Keycloak service error"),
    ...
    REQUIRED_FIELD_MISSING(
            HttpStatus.BAD_REQUEST, "REQUIRED_FIELD_MISSING", "Required field is missing"),
    ...
    CONFIGURATION_ERROR(
            HttpStatus.INTERNAL_SERVER_ERROR, "CONFIGURATION_ERROR", "Configuration error");
